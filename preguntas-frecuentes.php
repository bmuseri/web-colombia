...
<head>
        ...
        <title>Solventa Preguntas Frencuentes</title>
</head>
<body>
    <div class="bcg-mobile" id="BcgMobile"></div>

    <div class="ContainerBtnChat">
        <div class="chat-icon-box"><img class="" src="assets/img/chat-icon-violeta.svg" alt=""></div>
    </div>
    ...
    ?>
        ...
        <section class="faqs" id="faqs">
            <div class="container">
                ...
                <h2 class="h2-purple">Preguntas Frecuentes</h2>
                ...
                <div class="box-cards d-flex" id="BoxCardsContainer">
                        <div class="card-icon" id="prestamos">
                                ...
                                <p class="grey-txt">Toda la información sobre cada etapa del tu préstamo.</p>
                        </div>
                        <div class="card-icon card-icon-middle" id="pagos">
                                <div>
                                </div>
                                <p class="purple-title" id="TitlePagos">Pagos</p>
                                <p class="grey-txt">Toda la información sobre los medios y forma de pago de tu préstamo.</p>
                        </div>                    
                        <div class="card-icon" id="nosotros">
                                <div>
                                    
                                </div>
                                <p class="purple-title" id="TitleNosotros">Nosotros</p>
                                <p class="grey-txt" id="txt3">Toda la información sobre Solventa para tu seguridad en la elección.</p>
                        </div>                  
                </div>
        ...
        <section class="container-faqs" id="ContainerFaqs">

           <div class="container" id="PreguntasNosotros">
               <div class="faq-box">
                    <h3>¿Qué es Solventa y cómo funciona? </h3>
                    <div class="text-faqs">
                           <p>Somos una Fintech Internacional en expansión que nació con el fin de ofrecer Préstamos Personales 100% online de una manera rápida y simple. Sin trámites ni papeleos.</p>
                           <p>Adaptadas a las necesidades de nuestros clientes y con la tecnología como medio para una gestión fácil pero de calidad, nuestros asesores los ayudarán a entrar en el mundo digital. Trabajamos con las mejores herramientas para que puedas tener tu dinero acreditado en minutos.</p>
                           <p class="bold">Nos destacamos por nuestra velocidad y facilidad para otorgar Préstamos en el acto.</p>
                           <p class="bold-xs">¡Somos Solventa!</p>
                    </div>
               </div>
               <div class="faq-box">
                <h3>¿Por qué tengo que elegir Solventa?</h3>
                <div class="text-faqs" id="Nosotrostextfaqs2">
                    <p> - La solicitud es <span class="bold">100% online</span> (desde tu computadora o celular). Lo podés hacer desde la comodidad de tu casa. Sin trámites, sin filas ni papeleo.</p>
                    <p> - Servicio <span class="bold">rápido, confiable y seguro</span>.</p>
                    <p> - Contamos con un <span class="bold">equipo de asesores</span> de Atención al Cliente capacitados y amables para poder ayudarte y guiarte ante cualquier inconveniente o inquietud. </p>
                    <p> - Te brindamos el <span class="bold">detalle de tu préstamo</span> antes de que aceptes la solicitud. Somos transparentes. </p>
                    <p>- En sólo pocos pasos solicitás tu Préstamo y en <span class="bold">5 minutos te acreditamos el dinero</span> en tu cuenta bancaria. </p>
                    <p> - Retirás el dinero por cajero y lo pagas en la fecha que vos mismo acordaste abonarlo. </p>
                    <p> - Velocidad y facilidad para otorgar Préstamos en el acto.</p>

                    <p> Velocidad y facilidad para otorgar Préstamos en el acto.</p>
                </div>
               </div>
               <div class="faq-box">
                <h3>¿Quién puede ser cliente?</h3>
                <p class="text-faqs" id="Nosotrostextfaqs3">
                    Personas <span class="bold">mayores a 18 años</span> que que cuenten con una fuente de ingresos periódica y estable que te permita afrontar el compromiso financiero que vas adquirir con nosotros al solicitar el préstamo. 
                </p>
           </div>
           <div class="faq-box">
            <h3>¿Para qué me sirve pedir un Préstamo de Solventa? </h3>
            <div class="text-faqs" id="Nosotrostextfaqs4">
                <p>Nuestros <span class="bold">Préstamos personales</span> te permiten cubrir de manera rápida tus imprevistos de salud, gastos, inconvenientes, una compra, un gustito, una escapada fuera de la ciudad… ¡Salir del apuro!</p>
                <p class="bold">Por eso juntos Solventamos Momentos.</p>
            </div>
           </div>
           <div class="faq-box">
            <h3>¿Cómo los contacto?</h3>
            <div class="text-faqs" id="Nosotrostextfaqs5">
                <p>Podés hablarnos por el medio que más cómodo te resulte.
                    Nos llamas al <span class="bold">(000) 0000-0000</span> o nos escribís por <span class="WhatsApp al 00-0000-0000"></span>.
                    </p>
                    <p>Nuestros Horarios de Atención son:</p>
                    <p>
                        -	xxxx a xxxx de 0 a 00hs.
                    </p>
                    <p>
                        -	xxxx de 00 a 00hs.
                    </p>
                    ...
                    <p>¡Recordá no dejar tus datos personales en los comentarios públicos para cuidar tu privacidad!</p>
            </div>
           </div> 
           <div class="faq-box">
            <h3>¿Solventa tiene intermediarios? </h3>
            <div class="text-faqs" id="Nosotrostextfaqs6">
                <p>Solventa no utiliza intermediarios. Siempre estate atento a esta información para evitar estafas.</p>
                <p>Por eso tené presente estos consejos: no pongas tus datos personales públicamente ni a terceros no autorizados.</p>
                <p>La única forma de solicitar el préstamo con Solventa es a través de nuestra web completando el formulario.</p>
                <p> No utilizamos intermediarios. En Solventa manejamos una operación transparente y directa.</p>
                <p>En Solventano pedimos adelanto de dinero para la solicitud de un préstamo. 
                    Nuestros únicos medios de comunicación están publicados en nuestra web.
                    </p>
            </div>
           </div>                       
           </div>

           <div class="container" id="PreguntasPagos">
                <div class="faq-box">
                     <h3 id="Pagosh3click1">¿Cuándo comienza el pago de la cuota? </h3>
                     <div class="text-faqs">
                           <p>El pago de la cuota de tu préstamo lo elegís vos al iniciar la solicitud. Podés abonarlo desde el día 00 hasta el día 00.</p>
                     </div>
                </div>
                <div class="faq-box">
                 <h3 id="Pagosh3click2">¿Dónde y cómo pago mi Préstamo? </h3>
                 <div class="text-faqs" >
                     Trabajamos con diversas entidades y sistema de pago  para que elijas el que más te guste como PSE, Baloto, Éxito, Carulla y Surtimax.
                     <p>
                       <span class="bold">PSE:</span> Es el medio de pago más rápido. Puedes pagar directamente desde Solventa usando tu cuenta bancaria. 
                       <p>
                          <span class="bold">Baloto:</span> Con el número de convenio 00000, tu número de cédula y el valor a pagar, podrás pagar en cualquier punto baloto del país. Tomará 1 día hábil en actualizarse en tu cuenta Solventa. 
                       </p>
                       <p>
                        <span class="bold">Éxito, Carulla, Surtimax:</span> Descarga la factura en tu cuenta Solventa para que puedas hacer tu pago en cualquier cajero del país. Tomará 1 día hábil en actualizarse en tu cuenta Solventa.
                       </p>
                ...
                <div class="faq-box">
                 <h3>¿Qué sucede si no pago en término la cuota?</h3>
                 <div class="text-faqs" >
                     <p>Te recomendamos que siempre abones en término el pago de tu préstamo. Más adelante tendrás beneficios extra por el pago en término. 
                    Si entrás en mora nuestro departamento de cobranza se contactará con vos para regularizar el pago. Si no logramos contactarte para ayudar a tu situación se aplicará las cláusulas de incumplimiento de nuestro contrato de préstamo. 
                    Siempre recordá que ante cualquier consulta o para contarnos tu situación podés comunicarte con nosotros. 
                    </p>
                 </div>
            </div>
            <div class="faq-box">
             <h3 >¿Qué tasas y cargos cobran? </h3>
             <div class="text-faqs">
                 <p>En Solventa brindamos un servicio transparente, seguro y directo. Por eso te mostramos nuestras tasas y cargos antes que solicites finalmente el préstamo.</p>
                 <ul>
                     <li> <span class="• Seguro: "></span> pago de póliza de aseguramiento sobre el valor de utilización del cupo del préstamo en caso de muerte o incapacidad del titular. Recuerda que si cuentas con un seguro que cubra este tipo de obligaciones, lo puedes utilizar con nosotros, solo debes enviar las información y certificados necesarios (en este caso no te cobraremos este cargo).</li>
                     <li>•	Administración: garantiza la disponibilidad de tu cupo de préstamo asignado. Lo deberás cancelar solo una vez cada 30 días mientras tengas uno o más créditos activos, en caso contrario no te lo cobraremos.</li>
                     <li>•	Cargos tecnológicos:  cargos asociados al uso de la plataforma, relacionados con el manejo y beneficios que podrás obtener dentro de nuestro sistema. Tendrás acceso a una cuenta desde la cual podrás hacer seguimiento al estado de tu préstamo. </li>
                     <li>•	Interés: Es el índice utilizado para medir el costo de tu crédito. La tasa de interés cobrada por Solventa en todos tus préstamos es del 00% E.A. (Efectivo Anual)</li>
                 </ul>
             </div>
            </div>
           ...
           <div class="container" id="PreguntasPrestamos">
                <div class="faq-box">
                     <h3>¿Qué requisitos necesito para solicitar el Préstamo? </h3>
                     <div class="text-faqs" >
                            <p>Sólo necesitas:</p>
                            <p> - Ser mayor de edad </p>
                            <p> - Residir en Colombia </p>
                            <p> - Tener una cuenta bancaria (corriente o de ahorro) a tu nombre </p>	
                            <p> - Tener un número de celular personal</p> 	
                            <p> - Tener correo electrónico de uso personal, no laboral.</p>
                     </div>
                </div> 
                
                <div class="faq-box">
                 <h3>¿Cuánto dinero puedo pedir y en cuántas cuotas puedo pagarlo?</h3>
                 <div class="text-faqs">
                    <p class="bold">Te prestamos desde $000.000 hasta $000.000</p>
                    <p>Una vez que cargues tus datos en la solicitud de Préstamo se hace un análisis de tu perfil crediticio para validar tu identidad y una vez aprobado el préstamo acreditamos el dinero que solicitaste en tu cuenta bancaria para que lo retires por cualquier cajero. Después pagas el préstamo en 1 cuota la fecha que vos mismo elegiste para abonarlo.</p>
                 </div>
                </div>
                <div class="faq-box">
                 <h3>¿Cuáles son los pasos para solicitar el Préstamo?</h3>
                 <div class="text-faqs">
                     <p>Para solicitar tu cupo de préstamo con Solventa, primero tenes que ingresar a nuestra página <a href="www.solventa.co ">www.solventa.co </a>
                        Luego elegís el monto de dinero que necesitás que es mejor para alcanzar tus objetivos y <span class="bold">la fecha de cuando lo vas abonar</span> . Ves el detalle total de tu préstamo porque somos transparentes y no te ocultamos ningún dato.
                        Luego comenzás con la solicitud en pocos minutos con tus <span class="bold">datos personales y laborales</span> porque queremos conocerte mejor.
                        Después respondes algunas preguntas así <span class="bold">validamos tu identidad </span> por tu seguridad.
                        Nos das unos minutos así analizamos y validamos tu información para contarte el <span class="bold">estado de tu préstamo</span>.
                        En el caso que el préstamo este aprobado terminas la solicitud con tu <span class="bold">firma digital y tus datos bancarios</span> así acreditamos el <span class="bold">dinero en tu cuenta bancaria</span>. Y podes retirarlo por cualquier cajero automático.
                        </p>
                 </div>
            </div>
            <div class="faq-box">
                <h3>¿Qué tipo de cuenta bancaria necesito?</h3>
                <p class="text-faqs">
                   Necesitás CBU con cuenta sueldo.
                </p>
            </div> 
            <div class="faq-box">
             <h3>¿Cómo sé si mi solicitud fue aprobada o rechazada?</h3>
             <p class="text-faqs">
                Recordá siempre que la carga de tus datos nos permite analizar tu perfil crediticio. Y así indicarte si esta todo correcto para otorgarte el Préstamo o probar en 30 días en el caso que no cumplas con algún requisito o regularices tu situación financiera en el caso de alguna deuda pendiente que tengas. 
                Si no aprobamos tu solicitud o te ofrecemos una oferta menor, es porque nuestra tecnología de análisis encontró que tu capacidad de endeudamiento no es suficiente.
                Pero a medida que solicites y pagues a tiempo podés solicitar montos más altos.
                Por motivos de desaprobación siempre podes comunicarte con nosotros para saber bien cuál fue el motivo del rechazo.                
             </p>
            </div> 
            <div class="faq-box">
                <h3>Cargue mis datos pero no me otorgaron el Préstamo ¿Por qué? </h3>
                <p class="text-faqs">
                    ¡Tranquilo! Seguramente hay algún requisito no cumplido. Verificalos nuevamente o consultá si tenés alguna deuda que impide el beneficio de un Préstamo.
                    Por motivos de desaprobación siempre podes comunicarte con nosotros para saber bien cuál fue el motivo del rechazo.                                   
                </p>
            </div>             
            <div class="faq-box">
                <h3>¿Puedo pedir dos préstamos en simultáneo? </h3>
                <p class="text-faqs">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit laboriosam sunt, harum in nostrum culpa illo sed maiores. A provident praesentium maiores eaque temporibus illo? Ex error hic facere ipsa!                    
                </p>
            </div> 
            <div class="faq-box">
                <h3>¿Puedo pedir dos préstamos en simultáneo?</h3>
            ...
            <div class="faq-box">
                <h3 id="Prestamosh3click9">¿Cuándo me depositan o desembolsan el dinero?</h3>
                <p class="text-faqs">
                    Luego de haber sido aprobado el préstamo y realizado la firma digital de tu contrato con nosotros, te depositaremos el dinero en un máximo de un día hábil. El tiempo de operación puede ser menor, depende del banco donde tengas tu cuenta y la hora en la que hayas realizado la solicitud.                 
                </p>
            </div>               
        ...
        <section class="help-section">
            <div class="container">
                    <h2 class="h2-purple">Estamos para ayudarte</h2>
                    <p class="text-align-center subt-h2">Si no encontras la pregunta que necesitas ¡No te preocupes! Escribinos.</p>

                <div class="container-box-help d-flex">
                        <div class="box-help" id="Btnsolicitud">
                           
                            <div class="solicitud d-flex" >
                                    <div class="icon-box-help">
                                        <img src="assets/img/solicitud-icon.svg" alt="icono click">
                                    </div>
                                    <p class="txt-help">Solicitud <br> de préstamo</p>
                            </div>
                          
                        </div>

                        <div class="box-help" id="BtnPagoPrestamo">
                            
                                <div class="reclamos d-flex" >
                                        <div class="icon-box-help">
                                            <img src="assets/img/reclamos-icon.svg" alt="icono click">
                                        </div>
                                        <p class="txt-help">Pago del <br> préstamo</p>
                                </div>
                          
                        </div>  
                </div>
                
                <div class="CobranzaModal BoxModal" id="SolicitudModal">

                    <div class="ModalWraper">
                          <div><img class="closeimg" id="closeModalSolicitud" src="assets/img/close.svg" alt="cruz icono"></div>
                          <p class="titlecobranza">SOLICITUD</p>
                          <button class="btncall">Llamada</button>
                          <button class="btnws">Whatsapp</button>
                    </div>

                </div>

                <div class="CobranzaModal BoxModal" id="PagoModal">

                    <div class="ModalWraper">
                          <div><img class="closeimg" id="closeModalPago" src="assets/img/close.svg" alt="cruz icono"></div>
                          <p class="titlecobranza">PAGO</p>
                          <button class="btncall">Llamada</button>
                          <button class="btnws">Whatsapp</button>
                    </div>
       ...
       <script src="assets/js/main-faqs.js" ></script>
